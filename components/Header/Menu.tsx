...
export default function Menu() {
  ...
  return (
    <motion.div className={`bg-white ${headerInView?"top-20":"top-16"} z-30 flex flex-col space-height items-center lg:hidden py-24 fixed left-0 w-full`} style={{height:"94vh"}} variants={MenuBarAnimation} initial="initial" animate="animate" exit="exit">
