...
export default function Hero() {
  ...
  return (
    <div className='mt-8 flex lg:items-center flex-wrap overflow-hidden '>
        <div className='w-full relative lg:right-2 pt-8 lg:pt-0 lg:w-6/12 mb-20 lg:mb-0 widepadding lg:pr-2 lg:pl-40'>
            <motion.div variants={heroContainer} initial="initial" animate="animate">
                ...
                <motion.div  variants={heroChildren} className='mt-8 flex justify-center lg:justify-start'>
        ...
        <div className='w-full lg:w-6/12 h-[885px] sm:h-[750px] md:h-[614px] relative z-20 mt-12 lg:mt-0 left-4'>
            <DataComponent/>
            <MediaType/>
            <HeroChart/>
        </div>
